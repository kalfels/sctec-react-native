      ...
      * -------------------------------------------------------------- *
       ...
       p04-abre-senh.
           ...
           if ws77-statsenh not =  "00" 
              string "PROBLEMAS NA ABERTURA DO ARQUIVO USU�RIOS... ",
      ...
      * ------------------ ROTINAS DE PROCESSAMENTO ------------------ *
       ...
       p10-accept-usuario.
           read senh.
           if ws77-statsenh not =  "00"
              move "USU�RIO N�O CADASTRADO NO ARQUIVO..." to ws77-msg
              perform p80-mostra-msg
              close fili senh
              display " "             at 1680
              go p99-exit.
       ...
       p11-accept-filial.
           read fili.
           if ws77-statfili not =  "00"
              move "FILIAL N�O CADASTRADA NO ARQUIVO..." to ws77-msg
              perform p80-mostra-msg
       ...
       p12-accept-data1.
           ...
           if ws77-data1    not =  ws77-data
              string "DATA ATUAL CORRETA � ", ws77-datavideo, "...",
       ...
       p13-mostra-menu.
           ...
           display "Utilize as Setas de Movimenta��o...       " at 2412.
           ...
           move "DISPON�VEL ........... (   )" to ws03-descricao(12).
       ...
       p15-abre-sen1.
           ...
           read sen1.
           if ws77-statsen1 not =  "00"
              move "ACESSO N�O PERMITIDO A ESTE SISTEMA..." to ws77-msg
              perform p80-mostra-msg
              close sen1
              go p13-mostra-menu.
